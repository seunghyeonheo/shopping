...
public class ReviewController {
  ...
  @GetMapping("/review/{contentsno}")
  public ResponseEntity<ReviewDTO> get(@PathVariable("contentsno") int contentsno) {

    log.info("get: " + contentsno);

    return new ResponseEntity<>(service.read(contentsno), HttpStatus.OK);
  }
  ...
  @DeleteMapping("/review/{contentsno}")
  public ResponseEntity<String> remove(@PathVariable("contentsno") int contentsno) {

    log.info("remove: " + contentsno);

    return service.delete(contentsno) == 1 ? new ResponseEntity<>("success", HttpStatus.OK)
        : new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
